...
const ViewUserData = ({userDivData, userDiv, setUserDiv}) => {
  return (
    <>
      ...
      <div className={`${userDiv} top-0 left-0 h-screen w-full flex items-center justify-center`}>
        <div className='bg-white rounded p-4 w-[80%] md:w-[50%] lg:w-[40%] text-zinc-800'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={() => setUserDiv("hidden")}><RxCrossCircled size={24}/></button>
            </div>
            <div className='mt-2'>
                <label htmlFor="">
                    Name:{" "}
            ...
            <div className='mt-4'>
                <label htmlFor="">
                    Mobile: <span className='font-semibold'>{userDivData.phone}</span>
                </label>
            </div>
            <div className='mt-4'>
                <label htmlFor="">
