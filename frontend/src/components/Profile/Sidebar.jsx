  ...
  return (
    <div className='bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-auto lg:h-[100%]'>
      <div className='flex items-center flex-col justify-center'>
        {" "}
        <img src={data.avatar} alt="h-[12vh]" />
      ...
      {role === "user" && (
        ...
        <Link to="/profile" className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all'>
          ...
          <Link to="/profile/order-history" className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all mt-4'>
            Order History
          </Link>
          <Link to="/profile/settings" className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all mt-4'>
            Settings
          </Link>
        </div>
      )}
      {role === "admin" && (
        ...
        <Link to="/profile" className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all'>
          ...
          <Link to="/profile/add-book" className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all mt-4'>
            Add Books
          </Link>
        </div>
      )}
